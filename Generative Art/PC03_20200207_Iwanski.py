...
#200207
#
#This code creates art based on random numbers dictating the angles, start and end positions, and colors. I was inspired by DNA depictions and metro maps
...
win = Screen() #set up screen
win.bgcolor("black") #black background

dna = Turtle(visible=False) #set up the turtle
dna.width(2)
dna.speed("fastest")
dna.up()
